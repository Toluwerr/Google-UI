...
function NotificationManager.Push(self, config)
	...
	Tween(progressFill, {Size = UDim2.new(0, 0, 1, 0)}, duration, Enum.EasingStyle.Linear, Enum.EasingDirection.Out, function()
		Tween(notifFrame, {Position = UDim2.new(1, 10, 1, -10), BackgroundTransparency = 1, shadow.ImageTransparency = 1}, 0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out, function()
			notifFrame:Destroy()
